...
2. **2026-06-30 — Raw Ingest** — 69 arquivos em `_raw/` avaliados: 3 processados (2 criados, 1 duplicado), 66 Microsoft Graph API docs não relevantes ignorados.
3. **2026-06-27 — wiki-lint --consolidate** — 59 mudanças: 29 lifecycle corrections, 15 tag normalizations, 8 orphan rescue cross-refs, 9 broken link fixes, 1 confidence fix
