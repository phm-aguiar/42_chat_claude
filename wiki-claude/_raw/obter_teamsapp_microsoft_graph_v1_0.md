---
title: "Obter teamsApp - Microsoft Graph v1.0"
source: "https://learn.microsoft.com/pt-br/graph/api/teamsapp-get?view=graph-rest-1.0&tabs=http"
author:
  - "[[devjha-ms]]"
published:
created: 2026-06-30
description: "Obtenha uma aplicação ativada no canal especificado dentro de uma equipa."
tags:
  - "clippings"
---
## Obter teamsApp
...
Obtenha uma [aplicação ativada](https://learn.microsoft.com/pt-br/graph/api/resources/teamsapp?view=graph-rest-1.0) no [canal](https://learn.microsoft.com/pt-br/graph/api/resources/channel?view=graph-rest-1.0) especificado dentro de uma [equipa](https://learn.microsoft.com/pt-br/graph/api/resources/team?view=graph-rest-1.0).
...
| --- | --- | --- |
| Delegado (conta corporativa ou de estudante) | TeamsAppInstallation.ReadForTeam | TeamsAppInstallation.ManageSelectedForTeam, TeamsAppInstallation.ReadForUser, TeamsAppInstallation.ReadWriteForTeam |
...
Se for bem-sucedido, este método devolve um `200 OK` código de resposta e um objeto [teamsApp](https://learn.microsoft.com/pt-br/graph/api/resources/teamsapp?view=graph-rest-1.0) no corpo da resposta.
