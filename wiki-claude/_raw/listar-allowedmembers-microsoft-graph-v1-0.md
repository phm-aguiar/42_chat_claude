---
title: "Listar allowedMembers - Microsoft Graph v1.0"
source: "https://learn.microsoft.com/pt-br/graph/api/sharedwithchannelteaminfo-list-allowedmembers?view=graph-rest-1.0&tabs=http"
author:
  - "[[devjha-ms]]"
published:
created: 2026-06-30
description: "Obtenha a lista de conversationMembers que podem acessar um canal compartilhado."
tags:
  - "clippings"
---
## Listar allowedMembers

Namespace: microsoft.graph

Obtenha a lista de [conversationMembers](https://learn.microsoft.com/pt-br/graph/api/resources/conversationmember?view=graph-rest-1.0) que podem acessar um [canal](https://learn.microsoft.com/pt-br/graph/api/resources/channel?view=graph-rest-1.0) compartilhado.

Este método não devolve as seguintes [conversaçõesMembers](https://learn.microsoft.com/pt-br/graph/api/resources/conversationmember?view=graph-rest-1.0) da [equipa](https://learn.microsoft.com/pt-br/graph/api/resources/team?view=graph-rest-1.0):
...
Este método suporta os `$select` [parâmetros de consulta OData](https://learn.microsoft.com/pt-br/graph/query-parameters) e `$count` para personalizar a resposta.
